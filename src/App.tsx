...
export default function App() {
  ...
  const [rightPanel, setRightPanel] = useState<"review" | "chat" | null>(() => {
    const v = localStorage.getItem("layout.rightPanel");
    return v === "chat" ? "chat" : v === "hidden" ? null : "review";
  });
        ...
        <ActivityBar
          items={[
            ...
            },
            {
              ...
              icon: (
                <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M21 11.5a8.4 8.4 0 0 1-8.5 8.5 8.6 8.6 0 0 1-4-.9L3 20l1.4-4.5A8.4 8.4 0 0 1 3.5 11 8.4 8.4 0 0 1 12 2.5a8.4 8.4 0 0 1 9 9z" />
                </svg>
              ),
            },
          ]}

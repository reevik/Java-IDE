...
export default function MergeTool({ root, path, onResolved, onClose }: Props) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[85] flex flex-col bg-black/50 backdrop-blur-sm">
      <div className="switch-dialog m-3 flex min-h-0 flex-1 flex-col overflow-hidden rounded-xl shadow-2xl">
        {/* Header */}

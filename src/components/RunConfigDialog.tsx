...
export function KindIcon({ type }: { type: RunType }) {
  switch (type) {
    ...
    case "spring":
      // Spring leaf mark (matches the Spring rail-panel icon).
      return (
        <svg viewBox="0 0 24 24" width="14" height="14" className="shrink-0 text-[#6db33f]" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
